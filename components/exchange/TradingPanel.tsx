          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                step="0.01"
                min="0"
                className="w-full bg-zinc-800 border border-zinc-700 rounded-lg px-4 py-3 text-white font-medium focus:outline-none focus:border-red-600"
              />
              <div className="absolute right-3 top-1/2 -translate-y-1/2 flex gap-1">
                <button
                  onClick={() => setPrice(bestBid.toFixed(2))}
                  className="text-xs px-2 py-1 bg-zinc-700 rounded text-gray-400 hover:text-white"
                >
                  Bid
                </button>
                <button
        ...
        <div className="grid grid-cols-4 gap-2">
          {[0.25, 0.5, 0.75, 1].map((percent) => (
            <button
              ...
              className="py-2 text-xs font-medium bg-zinc-800 rounded-lg text-gray-400 hover:text-white hover:bg-zinc-700 transition"
            >
              {percent * 100}%
            </button>
          ))}
